...
const CreateNew = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        setMessage(`a new anecdote ${content} created!`)
        navigate('/')
    }
...
const Notification = ({notification, setNotification}) => {
    useEffect(() => {
        if (notification !== ''){
            ...
            return () => clearTimeout(timer) //if there is a new message it resets the timer so that it will be displayed the full 5 seconds
        }
    ...
    return (
        <div>
            ...
            <Routes>
                ...
                <Route path="/create-new" element={<CreateNew addNew={addNew} setMessage={setNotification}/>}/>
